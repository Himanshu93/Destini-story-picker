...
String getStory(int storyNum) {
  return this._storyData[storyNum].storyTitle;
}

String getChoice1(int storyNum) {
  return this._storyData[storyNum].choice1;
}

String getChoice2(int storyNum) {
  return this._storyData[storyNum].choice2;
}
